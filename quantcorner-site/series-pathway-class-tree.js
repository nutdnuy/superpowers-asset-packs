(function(){
  ...
  var nodes = [
    ...
    {id:"pm1",branch:"pm",type:"skill",x:292,y:52,title:"Asset Allocation",tag:"PORTFOLIO PATH",max:"MAX EP 8",sym:"AA",desc:"strategic/tactical allocation, constraints, rebalance rules",gets:["แปลง objective เป็น allocation rule","รู้จัก rebalance policy","ตั้ง constraint แบบไม่หลอกตัวเอง"],exercise:"ออกแบบ policy portfolio 60/40 เวอร์ชัน quant"},
    {id:"pm2",branch:"pm",type:"skill",x:470,y:52,title:"Factor Portfolio",tag:"PORTFOLIO PATH",max:"MAX EP 10",sym:"FA",desc:"factor exposure, signal weighting, turnover and capacity",gets:["รวม signals เป็นพอร์ต","ตรวจ exposure และ crowding","วัด turnover/capacity"],exercise:"สร้าง factor score แล้วจัด portfolio แบบ rule-based"},
    {id:"pm3",branch:"pm",type:"skill",x:648,y:52,title:"Risk Budgeting",tag:"PORTFOLIO PATH",max:"MAX EP 8",sym:"RB",desc:"risk contribution, concentration, drawdown and mandate limits",gets:["กำหนด risk budget","อ่าน concentration risk","เชื่อม sizing กับ mandate"],exercise:"ทำ risk contribution table ของพอร์ตตัวอย่าง"},
  ...
  function iconSvg(kind) {
    var icons = {
      pm: '<circle cx="12" cy="12" r="8"></circle><path d="M12 4v8l6 3"></path>',
      pricing: '<path d="M6 8h12"></path><path d="M12 5v14"></path><path d="M7 8l-3 6h6L7 8z"></path><path d="M17 8l-3 6h6l-3-6z"></path>',
      trader: '<path d="M4 17l5-5 4 3 7-8"></path><path d="M15 7h5v5"></path>',
      risk: '<path d="M12 3l7 3v5c0 4.4-2.8 8.1-7 10-4.2-1.9-7-5.6-7-10V6l7-3z"></path><path d="M9 12l2 2 4-5"></path>',
      f1: '<path d="M4 18h16"></path><path d="M5 18c2.4-9 11.6-9 14 0"></path><path d="M12 7v11"></path>',
      f2: '<ellipse cx="12" cy="6" rx="6" ry="3"></ellipse><path d="M6 6v6c0 1.7 2.7 3 6 3s6-1.3 6-3V6"></path><path d="M6 12v5c0 1.7 2.7 3 6 3s6-1.3 6-3v-5"></path>',
      f3: '<path d="M5 19V9"></path><path d="M10 19V5"></path><path d="M15 19v-7"></path><path d="M20 19V8"></path><path d="M3 19h18"></path>',
      f4: '<path d="M7 7h9a4 4 0 010 8H8"></path><path d="M8 4L5 7l3 3"></path><path d="M16 14l2 2 4-5"></path>',
      pm1: '<path d="M12 4a8 8 0 018 8h-8V4z"></path><path d="M12 12l5.7 5.7A8 8 0 114 12h8z"></path>',
      pm2: '<circle cx="6" cy="15" r="2"></circle><circle cx="12" cy="7" r="2"></circle><circle cx="18" cy="15" r="2"></circle><path d="M8 14l3-5"></path><path d="M13 9l3 5"></path><path d="M8 15h8"></path>',
      pm3: '<path d="M5 17a7 7 0 1114 0"></path><path d="M12 17l4-6"></path><path d="M8 17h8"></path>',
      job_pm: '<rect x="4" y="7" width="16" height="11" rx="2"></rect><path d="M9 7V5h6v2"></path><path d="M8 12h8"></path>',
      pr1: '<path d="M5 8h14"></path><path d="M12 5v14"></path><path d="M6 8l-2 5h5L6 8z"></path><path d="M18 8l-2 5h5l-3-5z"></path>',
      pr2: '<path d="M5 18L12 5l7 13H5z"></path><path d="M10 14h4"></path>',
      pr3: '<rect x="4" y="4" width="16" height="16" rx="2"></rect><path d="M4 10h16"></path><path d="M4 15h16"></path><path d="M10 4v16"></path><path d="M15 4v16"></path>',
      job_pricing: '<rect x="6" y="4" width="12" height="16" rx="2"></rect><path d="M9 8h6"></path><path d="M9 12h.01"></path><path d="M12 12h.01"></path><path d="M15 12h.01"></path><path d="M9 16h.01"></path><path d="M12 16h.01"></path><path d="M15 16h.01"></path>',
      tr1: '<path d="M5 6h14"></path><path d="M5 11h10"></path><path d="M5 16h7"></path><path d="M17 11l2 2-2 2"></path>',
      tr2: '<path d="M4 16l4-4 3 2 5-7 4 3"></path><path d="M16 7h4v4"></path>',
      tr3: '<path d="M4 7h10"></path><path d="M10 4l4 3-4 3"></path><path d="M20 17H10"></path><path d="M14 14l-4 3 4 3"></path>',
      job_trader: '<rect x="4" y="5" width="16" height="14" rx="2"></rect><path d="M8 10l2 2-2 2"></path><path d="M12 15h4"></path>',
      rk1: '<path d="M4 18h16"></path><path d="M5 18c3-10 8-10 14-2"></path><path d="M7 18c0-3 1-5 3-7"></path>',
      rk2: '<path d="M12 3v18"></path><path d="M5 7l14 10"></path><path d="M19 7L5 17"></path><circle cx="12" cy="12" r="3"></circle>',
      rk3: '<path d="M12 3l7 3v5c0 4.4-2.8 8.1-7 10-4.2-1.9-7-5.6-7-10V6l7-3z"></path><circle cx="12" cy="12" r="2.5"></circle><path d="M12 7v2"></path><path d="M12 15v2"></path><path d="M7 12h2"></path><path d="M15 12h2"></path>',
      job_risk: '<path d="M12 3l7 3v5c0 4.4-2.8 8.1-7 10-4.2-1.9-7-5.6-7-10V6l7-3z"></path><path d="M8 13l2.4 2.4L16 9"></path>'
    };
    return '<svg class="qpj-icon" viewBox="0 0 24 24" aria-hidden="true">' + (icons[kind] || icons.pm) + '</svg>';
  }
  ...
  function renderClasses() {
    var html = classes.map(function(c) {
      ...
      return '<button class="qpj-class ' + (on ? "on" : "") + '" type="button" data-class="' + c.id + '" style="--c:' + c.color + ';--bg:' + classBg(c.id, .1) + ';--glow:' + c.glow + ';--name:' + (on ? c.color : "#f4fbf7") + '">'
        + '<div class="qpj-class-head"><span class="qpj-avatar">' + iconSvg(c.id) + '</span><span><b>' + esc(c.name) + '</b><small>' + esc(c.thai) + '</small></span></div>'
        + '</button>';
    }).join("");
  ...
  function renderTop() {
    ...
    root.querySelector(".qpj-route").innerHTML = [
      '<span class="qpj-chip hot qpm" style="--c:' + c.color + ';--bg:' + classBg(c.id, .1) + '">' + iconSvg(c.id) + '<span>ACTIVE</span></span>'
    ].join("");
  }
  ...
  function renderNodes() {
    root.querySelector(".qpj-nodes").innerHTML = nodes.map(function(n) {
      ...
      return '<button class="' + cls + '" type="button" data-node="' + n.id + '" style="left:' + n.x + 'px;top:' + n.y + 'px;--w:' + d.w + 'px;--h:' + d.h + 'px;--c:' + color + ';--glow:' + glow + ';--bg:' + bg + '">'
        + '<span class="qpj-node-top"><span class="qpj-sym">' + iconSvg(n.id) + '</span><span><span class="qpj-node-title">' + esc(n.title) + '</span><span class="qpj-node-tag qpm">' + esc(n.tag) + '</span></span></span>'
