(function(){
  ...
  var css = [
    ...
    '.qpbg{position:fixed;inset:0;pointer-events:none;overflow:hidden;background:#060a09}.qpbg video{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;opacity:.4;filter:brightness(.54) contrast(.92) saturate(.72);transform:scale(1.03)}.qpbg:before{content:"";position:absolute;inset:0;background-image:linear-gradient(rgba(143,231,186,.026) 1px,transparent 1px),linear-gradient(90deg,rgba(143,231,186,.018) 1px,transparent 1px);background-size:42px 42px;opacity:.42;mask-image:linear-gradient(180deg,rgba(0,0,0,.9),rgba(0,0,0,.55) 56%,transparent 100%)}.qpbg:after{content:"";position:absolute;inset:0;background:linear-gradient(90deg,rgba(6,10,9,.94) 0%,rgba(6,10,9,.68) 46%,rgba(6,10,9,.88) 100%),linear-gradient(180deg,rgba(6,10,9,.14),#060a09 94%),repeating-linear-gradient(180deg,rgba(244,251,247,.022) 0 1px,transparent 1px 4px)}',
