(function(){
  ...
  var css = [
    '@import url("https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@500;600;700;800&family=Outfit:wght@500;600;700;800;900&display=swap");',
    ...
    '#qc-pathway-page{position:fixed;inset:0;z-index:2147483470;overflow:auto;overflow-x:hidden;scroll-behavior:smooth;background:#060a09;color:#f4fbf7;font-family:Outfit,Sukhumvit,system-ui,sans-serif;-webkit-font-smoothing:antialiased}',
    ...
    '.qpshell{position:relative;z-index:1;min-height:100%;background:linear-gradient(180deg,rgba(6,10,9,.18),#060a09 86%)}.qph{height:64px;display:flex;align-items:center;justify-content:space-between;padding:0 clamp(28px,4vw,56px);border-bottom:1px solid rgba(143,231,186,.15);background:#060a09}.qpbrand{color:#8fe7ba;font-size:15px;font-weight:800;white-space:nowrap}.qpnav{display:flex;gap:clamp(20px,2.8vw,34px);color:rgba(244,251,247,.65);font-size:14px;font-weight:800}.qpnav a:last-child{color:#72d2c8}.qpnav a:hover,.qpnav .on{color:#8fe7ba}.qpmenu{display:none;width:38px;height:38px;border:1px solid rgba(143,231,186,.5);border-radius:999px;background:rgba(143,231,186,.055);color:#f4fbf7;padding:0}.qpmenu span{display:block;width:16px;height:1.5px;margin:4px auto;border-radius:99px;background:currentColor;transition:transform .22s ease,opacity .18s ease}.qpopen .qpmenu span:nth-child(1){transform:translateY(5.5px) rotate(45deg)}.qpopen .qpmenu span:nth-child(2){opacity:0}.qpopen .qpmenu span:nth-child(3){transform:translateY(-5.5px) rotate(-45deg)}',
    '.qpmain{width:min(100%,1440px);margin:auto;padding:38px clamp(16px,3vw,42px) 88px}.qpj-hero{display:grid;grid-template-columns:minmax(0,1fr) minmax(280px,420px);gap:30px;align-items:end;margin:0 0 24px}.qpj-k{margin:0 0 12px;color:#8fe7ba;font-size:12px;font-weight:800;letter-spacing:.16em}.qpj-title{margin:0;font-family:Outfit,Sukhumvit,system-ui,sans-serif;font-size:clamp(46px,6.8vw,98px);line-height:.91;font-weight:900;letter-spacing:-.045em;text-wrap:balance}.qpj-title span{display:block;margin-top:14px;color:#8fe7ba;font-family:Sukhumvit,Outfit,sans-serif;font-size:.31em;line-height:1.18;letter-spacing:0;text-wrap:balance}.qpj-sub{max-width:650px;margin:20px 0 0;color:rgba(244,251,247,.7);font-size:16px;line-height:1.86;text-wrap:pretty}.qpj-hero-card{border:1px solid rgba(143,231,186,.2);border-radius:10px;background:linear-gradient(180deg,rgba(8,18,14,.78),rgba(2,7,5,.58));box-shadow:0 26px 90px rgba(0,32,22,.32),inset 0 1px 0 rgba(255,255,255,.045);backdrop-filter:blur(14px);padding:16px}.qpj-hero-card h2{margin:0 0 12px;color:rgba(244,251,247,.82);font-size:12px;letter-spacing:.16em}.qpj-step{display:flex;gap:10px;align-items:center;border-top:1px solid rgba(244,251,247,.08);padding:12px 0;color:rgba(244,251,247,.64);font-size:13px;line-height:1.5}.qpj-step:first-of-type{border-top:0}.qpj-step b{display:grid;place-items:center;flex:0 0 28px;height:28px;border:1px solid rgba(143,231,186,.35);border-radius:7px;color:#8fe7ba;background:rgba(143,231,186,.06)}',
    '.qpj-game{display:grid;grid-template-columns:315px minmax(0,1fr);gap:18px;align-items:start}.qpj-classes{border:1px solid rgba(143,231,186,.16);border-radius:10px;background:linear-gradient(180deg,rgba(6,16,12,.82),rgba(2,6,4,.66));box-shadow:0 22px 64px rgba(0,31,22,.22),inset 0 1px 0 rgba(255,255,255,.04);backdrop-filter:blur(12px);padding:14px;min-width:0}.qpj-panel-title{display:flex;align-items:center;justify-content:space-between;gap:12px;margin:0 0 12px;color:rgba(244,251,247,.74);font-size:11px;letter-spacing:.16em}.qpj-panel-title span{color:rgba(143,231,186,.82)}.qpj-class-list{display:grid;gap:10px}.qpj-class{width:100%;border:1px solid rgba(244,251,247,.095);border-radius:10px;background:rgba(255,255,255,.016);padding:13px;text-align:left;color:#f4fbf7;cursor:pointer;transition:border-color .24s cubic-bezier(.16,1,.3,1),background .24s cubic-bezier(.16,1,.3,1),box-shadow .24s cubic-bezier(.16,1,.3,1),transform .24s cubic-bezier(.16,1,.3,1)}.qpj-class:hover{transform:translateY(-2px);border-color:rgba(143,231,186,.28);background:rgba(255,255,255,.026)}.qpj-class:active{transform:translateY(0) scale(.988)}.qpj-class.on{border-color:var(--c);background:linear-gradient(135deg,var(--bg),rgba(255,255,255,.022));box-shadow:0 0 26px var(--glow),inset 0 1px 0 rgba(255,255,255,.05)}.qpj-class-head{display:flex;gap:11px;align-items:center}.qpj-avatar{display:grid;place-items:center;flex:0 0 42px;height:42px;border-radius:9px;border:1px solid var(--c);background:var(--bg);color:var(--c);font-size:13px;font-weight:900}.qpj-class b{display:block;color:var(--name,#f4fbf7);font-size:13px;line-height:1.28;text-wrap:balance}.qpj-class small{display:block;margin-top:4px;color:rgba(244,251,247,.52);font-size:11px;line-height:1.5;text-wrap:pretty}.qpj-class.on small{color:rgba(244,251,247,.72)}.qpj-stats{display:grid;gap:7px;margin-top:12px}.qpj-stat{display:grid;grid-template-columns:52px 1fr;gap:9px;align-items:center;color:rgba(244,251,247,.5);font-size:10px}.qpj-bars{display:grid;grid-template-columns:repeat(5,1fr);gap:4px}.qpj-bars i{height:6px;border-radius:2px;background:rgba(244,251,247,.09)}.qpj-bars i.on{background:var(--c);box-shadow:0 0 10px var(--glow)}.qpj-class-out{margin-top:12px;border-top:1px solid rgba(244,251,247,.08);padding-top:10px;color:rgba(244,251,247,.58);font-size:11px;line-height:1.55}',
    '.qpj-tree-panel{min-width:0;border:1px solid rgba(143,231,186,.16);border-radius:10px;background:linear-gradient(180deg,rgba(5,14,10,.74),rgba(2,7,5,.62));box-shadow:0 26px 90px rgba(0,31,22,.24),inset 0 1px 0 rgba(255,255,255,.04);backdrop-filter:blur(12px);overflow:hidden}.qpj-tree-top{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:18px;align-items:center;border-bottom:1px solid rgba(143,231,186,.14);padding:15px 17px;background:linear-gradient(180deg,rgba(143,231,186,.055),rgba(255,255,255,.012))}.qpj-tree-k{margin:0 0 5px;color:var(--c);font-size:11px;font-weight:800;letter-spacing:.15em}.qpj-tree-title{margin:0;color:#f4fbf7;font-size:23px;line-height:1.16;text-wrap:balance}.qpj-tree-copy{max-width:760px;margin:7px 0 0;color:rgba(244,251,247,.58);font-size:13px;line-height:1.65;text-wrap:pretty}.qpj-route{display:flex;gap:8px;flex-wrap:wrap;justify-content:flex-end}.qpj-chip{display:inline-flex;align-items:center;min-height:30px;border:1px solid rgba(244,251,247,.1);border-radius:7px;background:rgba(255,255,255,.018);padding:0 10px;color:rgba(244,251,247,.62);font-size:11px}.qpj-chip.hot{border-color:var(--c);color:var(--c);background:var(--bg);box-shadow:inset 0 1px 0 rgba(255,255,255,.04)}',
